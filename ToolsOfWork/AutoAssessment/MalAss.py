        ...
        for i in range(6, len(tmpStr)):
            ...
            if n >= 5:
                ...
                f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                              + "|"+"日期:"+tmpList[0][0] +
                              ",TCH掉话率（不含切换):"+tmpList[0][24]+'%'
                              + "|"+"日期:"+tmpList[1][0] +
                              ",TCH掉话率（不含切换):"+tmpList[1][24]+'%'
                              + "|"+"日期:"+tmpList[2][0] +
                              ",TCH掉话率（不含切换):"+tmpList[2][24]+'%'
                              + "|"+"日期:"+tmpList[3][0] +
                              ",TCH掉话率（不含切换):"+tmpList[3][24]+'%'
                              + "|"+"日期:"+tmpList[4][0] +
                              ",TCH掉话率（不含切换):"+tmpList[4][24]+'%'
                              + "|"+"日期:"+tmpList[5][0] +
                              ",TCH掉话率（不含切换):"+tmpList[5][24]+'%'
    ...
    if CellLine[2] == 'GSM SD建立成功率优化' or CellLine[2] == 'GSM SD建立成功率':
        ...
        for i in range(6, len(tmpStr)):
            ...
            if n >= 7:
                ...
                f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                              + "|"+"日期:"+tmpList[0][0] +
                              ",SDCCH建立成功率:"+tmpList[0][39]+'%'
                              + "|"+"日期:"+tmpList[1][0] +
                              ",SDCCH建立成功率:"+tmpList[1][39]+'%'
                              + "|"+"日期:"+tmpList[2][0] +
                              ",SDCCH建立成功率:"+tmpList[2][39]+'%'
                              + "|"+"日期:"+tmpList[3][0] +
                              ",SDCCH建立成功率:"+tmpList[3][39]+'%'
                              + "|"+"日期:"+tmpList[4][0] +
                              ",SDCCH建立成功率:"+tmpList[4][39]+'%'
                              + "|"+"日期:"+tmpList[5][0] +
                              ",SDCCH建立成功率:"+tmpList[5][39]+'%'
        ...
        if len(tmpStr) >= 7:
            ...
            for i in range(6, len(tmpStr)):
                ...
                if n >= 7:
                    ...
                    f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                                  + "|"+"日期:"+tmpList[0][0] +
                                  ",下行TBF掉线率:"+tmpList[0][54]+'%'
                                  + "|"+"日期:"+tmpList[1][0] +
                                  ",下行TBF掉线率:"+tmpList[1][54]+'%'
                                  + "|"+"日期:"+tmpList[2][0] +
                                  ",下行TBF掉线率:"+tmpList[2][54]+'%'
                                  + "|"+"日期:"+tmpList[3][0] +
                                  ",下行TBF掉线率:"+tmpList[3][54]+'%'
                                  + "|"+"日期:"+tmpList[4][0] +
                                  ",下行TBF掉线率:"+tmpList[4][54]+'%'
                                  + "|"+"日期:"+tmpList[5][0] +
                                  ",下行TBF掉线率:"+tmpList[5][54]+'%'
        ...
        if len(tmpStr) >= 7:
            ...
            for i in range(6, len(tmpStr)):
                ...
                if n >= 7:
                    ...
                    f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                                  + "|"+"日期:" +
                                  tmpList[0][0]+",EDGE下行IP吞吐率:" +
                                  tmpList[0][55]+''
                                  + "|"+"日期:" +
                                  tmpList[1][0]+",EDGE下行IP吞吐率:" +
                                  tmpList[1][55]+''
                                  + "|"+"日期:" +
                                  tmpList[2][0]+",EDGE下行IP吞吐率:" +
                                  tmpList[2][55]+''
                                  + "|"+"日期:" +
                                  tmpList[3][0]+",EDGE下行IP吞吐率:" +
                                  tmpList[3][55]+''
                                  + "|"+"日期:" +
                                  tmpList[4][0]+",EDGE下行IP吞吐率:" +
                                  tmpList[4][55]+''
                                  + "|"+"日期:" +
                                  tmpList[5][0]+",EDGE下行IP吞吐率:" +
                                  tmpList[5][55]+''
        ...
        if len(tmpStr) >= 7:
            ...
            for i in range(6, len(tmpStr)):
                ...
                if n >= 5:
                    ...
                    f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                                  + "|"+"日期:" +
                                  tmpList[0][0]+",TCH掉话率（不含切换):" +
                                  tmpList[0][24]+'%'
                                  + "|"+"日期:" +
                                  tmpList[1][0]+",TCH掉话率（不含切换):" +
                                  tmpList[1][24]+'%'
                                  + "|"+"日期:" +
                                  tmpList[2][0]+",TCH掉话率（不含切换):" +
                                  tmpList[2][24]+'%'
                                  + "|"+"日期:" +
                                  tmpList[3][0]+",TCH掉话率（不含切换):" +
                                  tmpList[3][24]+'%'
                                  + "|"+"日期:" +
                                  tmpList[4][0]+",TCH掉话率（不含切换):" +
                                  tmpList[4][24]+'%'
                                  + "|"+"日期:" +
                                  tmpList[5][0]+",TCH掉话率（不含切换):" +
                                  tmpList[5][24]+'%'
                                  + "|"+"日期:"+tmpList[6][0]+",TCH掉话率（不含切换):"+tmpList[6][24]+'%\n'))
                    f.close
                    break
        ...
        if len(tmpStr) >= 28:
            ...
            for i in range(len(tmpDateList)-27):
                ...
                if n <= 1:
                    ...
                    f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                                  + "|"+"日期:" +
                                  tmpDateList[i]+"~"+tmpDateList[i+6] +
                                  '周粒度六忙时4、5级干扰比例:' +
                                  str(sum(tmpDataList[i:i+7])/7)+'%'
                                  + "|"+"日期:"+tmpDateList[i+7]+"~"+tmpDateList[i+13]+'周粒度六忙时4、5级干扰比例:'+str(
                                      sum(tmpDataList[i+7:i+14])/7)+'%'
                                  + "|"+"日期:"+tmpDateList[i+14]+"~"+tmpDateList[i+20]+'周粒度六忙时4、5级干扰比例:'+str(
                                      sum(tmpDataList[i+14:i+21])/7)+'%'
    ...
    if CellLine[2] == 'GSM简报MVQ低接通' or CellLine[2] == 'GSM简报T拥塞' or CellLine[2] == 'GSM TCH拥塞':
        ...
        for i in range(6, len(tmpStr)):
            ...
            if n >= 5:
                ...
                f.writelines((CellLine[0]+"|"+CellLine[1]+"|"+"通过"
                              + "|"+"日期:"+tmpList[0][0] +
                              ",TCH感知拥塞率:"+tmpList[0][30]+'%'
                              + "|"+"日期:"+tmpList[1][0] +
                              ",TCH感知拥塞率:"+tmpList[1][30]+'%'
                              + "|"+"日期:"+tmpList[2][0] +
                              ",TCH感知拥塞率:"+tmpList[2][30]+'%'
                              + "|"+"日期:"+tmpList[3][0] +
                              ",TCH感知拥塞率:"+tmpList[3][30]+'%'
                              + "|"+"日期:"+tmpList[4][0] +
                              ",TCH感知拥塞率:"+tmpList[4][30]+'%'
                              + "|"+"日期:"+tmpList[5][0] +
                              ",TCH感知拥塞率:"+tmpList[5][30]+'%'
